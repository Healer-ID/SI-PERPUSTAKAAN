                                            ...
                                            while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="penerima">Nama Sisea</label>
                                                            ...
                                                            <div class="form-group">
                                                             ...
                                                             <option selected>Pilih Status</option>
                                                              <option value="Buah">Selesai</option>
                                                               <option value="Unit">Telat</option>
                                                               <option value="Meter">Hilang</option>
                                                            ...
                                                            <label for="ukuran">Nominal</label>
                                                            <input type="text" id="nominal" name="nominal" class="form-control" value="<?php echo $b['nominal'] ?>" disabled>
