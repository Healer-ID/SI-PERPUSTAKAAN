                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><font color="black"><a href="keluar.php">Data transaksi</a></li>
                                    <li><font color="black"><font color="black"><a href="masuk.php">Data Peminjaman</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Pengembalian</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php">Home</a></li>
                                <li><span>Data Pengembalian</span></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                         <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
                                            ...
                                            while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <tr>
                                                    <td><?php echo $no++ ?></td>
                                                    <td><?php echo $b['nopinjam'] ?></td>
                                                    <td><?php echo $b['nisn'] ?></td>
                                                    <td><?php echo $b['namasiswa'] ?></td>
                                                    <td><?php echo $b['kls'] ?></td>
                                                    <td><?php echo $b['ukuran'] ?></td>
                                                    <td><?php echo $b['nama'] ?></td>
                                                    <td><?php echo $b['jumlah'] ?></td>
                                                    <td><?php $tanggals=$b['tgl']; echo date("d-M-Y", strtotime($tanggals)) ?></td>

                                                    <a href="exportbrgmsk.php" target="_blank" class="btn btn-info">Cetak</a>
                                                    <td><button data-toggle="modal" data-target="#edit<?=$id;?>" class="btn btn-info">Cetak</button> <button>
                                                </tr>
                        ...
                        <div class="modal-body">
                            <form action="barang_masuk_act.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                        <option value="<?php echo $d['idx'] ?>"><?php echo $d['nama'] ?> <?php echo $d['jenis'] ?> <?php echo $d['merk'] ?>, Id. <?php echo $d['ukuran'] ?></option>
                                        <?php
                                }
                                ?>
                                    </select>
