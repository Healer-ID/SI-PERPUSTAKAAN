                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active"><a href="index.php"><i class="ti-desktop"></i><span>Dashboard</span></a></li>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="tmb_brg_act.php" method="post">
                                ...
                                <div class="form-group">
                                    <label>Id buku</label>
                                    <input name="ukuran" type="text" class="form-control" placeholder="Id barang">
                                </div>
                                <div class="form-group">
                                    <label>Stock</label>
