                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li><a href="index.php"><i class="ti-desktop"></i><span>Dashboard</span></a></li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaksi Data
                                    </span></a>
                                <ul class="collapse">
                                     <li class="active"><font color="black"><a href="keluar.php">Data Transaksi</a></font></li>
                                    <li><font color="black"><a href="masuk.php" >Data Peminjaman</a></font></li>
                                     <li><font color="black"><font color="black"><a href="kembali.php">Data Pengembalian</a></li>
                                </ul>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Peminjaman</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php">Home</a></li>
                                <li><span> Data peminjaman</span></li>
                            </ul>
                        </div>
                    </div>
										 ...
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											...
											while($b=mysqli_fetch_array($brg)){
												...
												<tr>
                                                    ...
                                                    <td><button data-toggle="modal" data-target="#edit<?=$id;?>"  class="btn btn-warning">Proses</button> 
												</tr>		
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="ukuran">No.pinjam</label>
                                                            <input type="text" id="nopinjam" name="nopinjam" class="form-control" value="<?php echo $b['nopinjam'] ?>" disabled>

                                                            <label for="ukuran">NISN</label>
                                                            <input type="text" id="nisn" name="nisn" class="form-control" value="<?php echo $b['nisn'] ?>" disabled>
                                                            ...
                                                            <input type="text" id="kls" name="kls" class="form-control" value="<?php echo $b['kls'] ?>" disabled>

                                                            <label for="ukuran">Id.Buku</label>
                                                            <input type="text" id="ukuran" name="ukuran" class="form-control" value="<?php echo $b['ukuran'] ?>" disabled>

                                                            <label for="nama">Identitas Buku</label>
                                                            ...
                                                            <label for="tanggal">Tgl.Pinjam</label>
                                                           ...
                                                           <button type="submit" class="btn btn-success" name="update"> Kirim+Cetak</button>
                                                            </div>
                                                            </form>
                                                        </div>
                                                        </div>
						...
						<div class="modal-body">
							<form action="barang_keluar_act.php" method="post">
								<div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label>Kelas </label>
                                    <input name="kls" type="text" class="form-control" placeholder="kls">
                                    </div>
