...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update buku set nisn='$nisn', nama='$nama', tgl_lhr='$tgl_lhr', kelas='$kelas',  where idx='$ids'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from buku where ids='$ids'");
    ...
    <div class="page-container">
        ...
        <div  class="sidebar-menu" style="background-color: white" >
            <div class="sidebar-header" style="background-color: white">
                    <a href="index.php"><img src="../smk.png" alt="logo" width="80%" style="background-color: white" ></a>
                    <a></a>
                    <h4>Administrator</h4>
                    <h4>Perpustakaan</h4>
            </div>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li><a href="index.php"><i class="ti-desktop"></i><span>Dasboard</span></a></li>
                              <li class="active"><a href="buku.php"><i class="ti-dashboard"></i><span>Data Siswa</span></a> </li>
                            <li><a href="stock.php"><i class="ti-dashboard"></i><span>Buku</span></a> </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaksi Data
                                    </span></a>
                                <ul class="collapse">
                                     <li><font color="black"><a href="keluar.php">Data Peminjaman</a></li>
                                    <li><font color="black"><font color="black"><a href="masuk.php">Data Pengembalian</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Data Siswa</h4>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right" style="color:white; padding:0px;">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
                                         <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            <?php 
                                            $brgs=mysqli_query($conn,"SELECT * from buku order by nama ASC");
                                            $no=1;
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit Siswa <?php echo $p['nama']?> - <?php echo $p['nisn']?> - <?php echo $p['kelas']?></h4>
                                                            ...
                                                            <input type="text" id="nisn" name="nama" class="form-control" value="<?php echo $p['nisn'] ?>">

                                                            <label for="nama">Nama</label>
                                                            <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $p['nama'] ?>">

                                                            <label for="tgl_lhr">Tanggal Lahir</label>
                                                            <input type="date" id="tgl_lhr" name="tgl_lhr" class="form-control" value="<?php echo $p['tgl_lhr'] ?>">

                                                            <label for="kelas">Kelas</label>
                                                            <input type="text" id="Kelas" name="Kelas" class="form-control" value="<?php echo $p['kelas'] ?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Siswa <?php echo $p['nama']?> - <?php echo $p['nisn']?> - <?php echo $p['tgl_lhr']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
    ...
    <!-- modal input -->
            <div id="myModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Masukkan Siswa manual</h4>
                        </div>
                        <div class="modal-body">
                            <form action="tmb_siswa_act.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="tgl_lhr" type="date" class="form-control" placeholder="tanggal lahir">
                                </div>
                                <div class="form-group">
                                    <label>kelas</label>
